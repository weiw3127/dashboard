...
import { Ecommerce, Orders, Calender, Employees, Stacked, Pyramid, Customers, Kanban, Area, Bar, Pie, Financial, ColorPick, ColorMapping, Editor } from './pages'
    ...
    <div>
        <BrowserRouter>
            <div className='flex relative dark:bg-main-dark-bg'>
                ...
                {activeMenu ? 
                (<div className='w-72 fixed sidebar dark:bg-secondary-dark-bg dg-white'>Sidebar</div>): 
